...
-- Minimize custom (ControlGUI + rainbow stroke)
do
	...
	pcall(function()
		local oldGui = gethui():FindFirstChild("ControlGUI")
		if oldGui then
			oldGui:Destroy()
		end
		local pg = Players.LocalPlayer:FindFirstChild("PlayerGui")
		if pg and pg:FindFirstChild("ControlGUI") then
			pg.ControlGUI:Destroy()
		end
	end)
	...
	if not l_ScreenGui_0.Parent then
		pcall(function()
			l_ScreenGui_0.Parent = Players.LocalPlayer:WaitForChild("PlayerGui")
		end)
	end

	local l_ImageButton_0 = Instance.new("ImageButton")
	l_ImageButton_0.Name = "MinimizeBtn"
	l_ImageButton_0.Size = UDim2.new(0, 72, 0, 72)
	l_ImageButton_0.Position = UDim2.new(0.15, 0, 0.15, 0)
	l_ImageButton_0.Image = "rbxassetid://94678517792779"
	l_ImageButton_0.BackgroundTransparency = 1
	l_ImageButton_0.AutoButtonColor = true
	...
	-- rainbow cycle stroke
	task.spawn(function()
		local i = 1
		while l_ScreenGui_0.Parent do
			l_UIStroke_0.Color = v471[i]
			i = i % #v471 + 1
			task.wait(0.12)
		end
	end)
	...
	do
		...
		l_ImageButton_0.InputBegan:Connect(function(input)
			if input.UserInputType == Enum.UserInputType.MouseButton1
				or input.UserInputType == Enum.UserInputType.Touch then
				dragging = true
				dragStart = input.Position
				startPos = l_ImageButton_0.Position
		...
		l_ImageButton_0.InputChanged:Connect(function(input)
	...
	local clickPos
	l_ImageButton_0.MouseButton1Down:Connect(function()
	...
	l_ImageButton_0.MouseButton1Click:Connect(function()
		...
		pcall(function()
			if RealWindow and RealWindow.Minimize then
				RealWindow:Minimize()
			elseif RealWindow and RealWindow.MinimizeBtn then
				RealWindow:MinimizeBtn()
			end
		end)
	end)

	print("[nyann os] ControlGUI minimize ready")
end
...
function Window:MakeTab(cfg)
	...
	local icon = cfg.Icon
	-- giữ rbxassetid:// nếu user truyền thẳng (vd icon cá)
	if type(icon) == "string" and icon:find("rbxassetid") then
		-- ok, pass through
	elseif type(icon) == "string" and #icon > 40 then
		icon = "info"
	end
